...
maxZone = 2926
total_wgt = 564043.02617679   # From ATRI calibration dataset, total weight value for all internal and external truck trips
                                # used to scale final weights to realistic value so intermodal can be added in
