...
## time periods.
##
## This incorporates part of the Emme macro toll_skim.mac to save AM Peak toll skim data,
## which is used by complete_toll_skim_matrices.py.
##
## Heither rev. 02-20-2022
## ==========================================================================================
import os
import sys
...
print("         SOLA Assignment Completed for Time Period {0}".format(tmPeriod))    